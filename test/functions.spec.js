...
describe('countNumber', () => {
  ...
  return object which contains counts of each numbers.`, () => {
    ...
    expect(countNumber('jdjjka000466588kkkfs662555'))
...
describe('isLeapYear', () => {
  ...
  is a leap year’ and if it isn’t, should return string - ‘ “year” 
  ...
  () => {
    ...
    expect(isLeapYear('2200-01-01 00:00:00'))
        .to.eql('2200 is not a leap year');
    expect(isLeapYear(1213131313135465656654564646542132132131))
        .to.eql('Invalid Date');
    expect(isLeapYear(1213131313)).to.eql('1970 is not a leap year');
  });
});
